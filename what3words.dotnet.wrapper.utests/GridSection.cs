...
namespace what3words.dotnet.wrapper.utests
{
    public class GridSection
    {
        ...
        {
            var result = await api.GridSection(new Square(new Coordinates(51.222609, -0.152898), new Coordinates(51.222011, 0.152311))).RequestAsync();
            Assert.IsFalse(result.IsSuccessful);
        ...
        {
            var result = await api.GridSection(new Square(new Coordinates(100,100), new Coordinates(51.222011, 0.152311))).RequestAsync();
            Assert.IsFalse(result.IsSuccessful);
