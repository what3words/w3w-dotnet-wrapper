...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public class AutosuggestSelectionRequest
    {
        ...
        public AutosuggestSelectionRequest(What3WordsV3 api, string rawInput, string sourceApi, Suggestion seletedSuggestion, AutosuggestOptions AutosuggestOptions)
        {
            this.api = api;
            this.options = AutosuggestOptions;
            this.rawInput = rawInput;
            this.selection = seletedSuggestion.Words;
            this.rank = seletedSuggestion.Rank;
